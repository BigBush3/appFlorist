...
export const insertProduct = (
  ...
  console.log(
    `http://${_host}/ibm/florist/bouquet/insert/item/${_checkid}/${_kompid}/${_itemid}/${_amount}/${_price}/${_total}`
  );
...
export const updateProduct = (_host, _checkid, _amount, _price, _total) => {
  console.log(
    `http://${_host}/ibm/florist/bouquet/update/item/${_checkid}/${_amount}/${_price}/${_total}`
  );
...
export const dontSave = (_host, _checkid, _uid) => {
  ...
  return fetch(
    `http://${_host}/ibm/florist/bouquet/dsave/${_checkid}/${_uid} `,
    {
      method: "GET",
      headers: {
        Accept: "application/json",
...
export const save = (_host, _checkid, _title) => {
  console.log(
    `http://${_host}/ibm/florist/bouquet/save/${_checkid}/${_title} `
  );
...
export const setTotal = (_host, _checkid, _price) => {
  console.log(
    `http://${_host}/ibm/florist/bouquet/set/checktotal/${_checkid}/${_price}`
  );
...
export const addPhoto = (_host, komplektcheckitemid, file) => {
  console.log(
    `http://${_host}/ibm/florist/bouquet/add/photo/${komplektcheckitemid}/${file}`
  );
...
export const getProductsInBouquet = (_host, _checkid, _kompid) => {
  console.log(
    `http://${_host}/ibm/florist/bouquet/prodlist/${_checkid}/${_kompid}`
  );
...
export const getProductsByPricelist = (_host, _pricelist) => {
  console.log(`http://${_host}/ibm/florist/bouquet/products2/0/${_pricelist}`);

  return fetch(`http://${_host}/ibm/florist/bouquet/products2/0/${_pricelist}`, {
    method: "GET",
    headers: {
      Accept: "application/json",
      "Content-Type": "application/json",
