...
export const setDiscount = (_host, _checkid, _discount) => {
  console.log(
    `http://${_host}/ibm/florist/check/set/discont/${_checkid}/${_discount}`
  );
...
export const insertProduct = (
  ...
  console.log(
    `http://${_host}/ibm/florist/check/insert/item/${_checkid}/${_kompid}/${_itemid}/${_amount}/${_price}/${_total}`
  );
...
export const insertBouquet = (_host, _checkid, _bouquet) => {
  console.log(
    `http://${_host}/ibm/florist/check/insert/bouquet/${_checkid}/${_bouquet}`
  );
...
export const updateProduct = (_host, _checkid, _amount, _price, _total) => {
  console.log(
    `http://${_host}/ibm/florist/check/update/item/${_checkid}/${_amount}/${_price}/${_total}`
  );
...
export const save = (_host, _checkid, _title) => {
  ...
  return fetch(
    `http://${_host}/ibm/florist/check/save/${_checkid}/${_title} `,
    {
      method: "GET",
      headers: {
        Accept: "application/json",
...
export const setTotal = (_host, _checkid, _price) => {
  console.log(
    `http://${_host}/ibm/florist/check/set/checktotal/${_checkid}/${_price}`
  );
...
export const setClient = (_host, _checkid, clientid) => {
  console.log(
    `http://${_host}/ibm/florist/check/set/client/${_checkid}/${clientid}`
  );
...
export const getPaymentsType = (_host, _checkid) => {
  console.log(
    `http://${_host}/ibm/florist/check/get/paymentstype/${_checkid} `
  );
...
export const addPayment = (_host, _checkid, ptype, total) => {
  console.log(
    `http://${_host}/ibm/florist/check/insert/payments/${_checkid}/${ptype}/${total}`
  );
...
export const getPricelist = (_host) => {
  console.log(`http://${_host}/ibm/florist/check/pricelist`);

  return fetch(`http://${_host}/ibm/florist/check/pricelist`, {
    method: "GET",
  }).then((response) => response.json());
};
