    ...
    return (
      <TouchableOpacity style={styles.select} onPress={this.props.onSelect}>
        {this.props.optionText ? 
          <Text style={styles.optionText} numberOfLines={1} ellipsizeMode="tail">{this.props.optionText}</Text> : 
          <Text style={styles.selectText} numberOfLines={1} ellipsizeMode="tail">{this.props.selectText}</Text>
        }
