    ...
    return (
      <View style={styles.input}>
        <TextInput 
          ...
          onChangeText={(value) =>  this.handlerValidation('inputValidation', this.state.validationType , value) }
        ...
        <View style={styles.numbers}>
          <Text style={styles.numbersText}>{this.state.validationType.length}/{this.props.numberLength}</Text>
        </View>
      </View>
    );
  }
