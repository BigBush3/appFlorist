  ...
  render() {
    ...
    return (
      <TouchableOpacity style={[styles.docsItem]} onPress={this.state.docPress}>
        {this.props.docType == 1 ? <Image style={styles.docsItemImage} source={docIcon} /> : null}
        {this.props.docType == 2 ? <Image style={styles.docsItemImage} source={docxIcon} /> : null}
        {this.props.docType == 3 ? <Image style={styles.docsItemImage} source={pdfIcon} /> : null}
        {this.props.docType == 4 ? <Image style={styles.docsItemImage} source={xlsxIcon} /> : null}
        <Text style={styles.docsItemText} numberOfLines={1} ellipsizeMode="tail">{this.props.docName}</Text>
